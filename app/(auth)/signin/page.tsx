...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50 flex items-center justify-center p-2">
          ...
          <div className="relative bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 p-8">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center space-x-4 mb-2">
                ...
                <div>
                  <h1 className="md:text-3xl sm:text-2xl text-xl font-bold text-white">Welcome Back</h1>
                  <p className="text-emerald-100">Sign in to Nur Quran</p>
                </div>
              </div>
            </div>
          </div>
