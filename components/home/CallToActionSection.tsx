    ...
    <section className="py-20 bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <CardContent className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-200">Dari 10K+ reviews</p>
                  </div>
                </div>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-white mb-2">Pembelajaran Interaktif</h4>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-white mb-2">Pelacakan Progres</h4>
                    <p className="text-emerald-200">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <div className="text-left">
              <p className="text-white font-semibold">Mulai gratis hari ini</p>
              <p className="text-emerald-200 text-sm">Tanpa biaya tersembunyi, selamanya</p>
            </div>
            <Link href="/signin">
              <Button 
                size="lg"
        ...
        <div className="mt-16 text-center">
          <p className="text-emerald-200 mb-6">Dipercaya oleh:</p>
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            <div className="text-white font-semibold">50K+ Pengguna</div>
            <div className="w-1 h-1 bg-white rounded-full"></div>
            <div className="text-white font-semibold">10+ Negara</div>
            <div className="w-1 h-1 bg-white rounded-full"></div>
